  ...
  return (
    ...
    { carpetas.map(
      (
        ...
        return (
          <Card key={ _id.toString() } name={ Demandado.Nombre } path={ '/Procesos' } idProceso={ idProceso } llaveProceso={ params.llaveProceso }>
            <Link href={ `tel:${ Celular }` }><span className='material-symbols-outlined'>phone_iphone</span></Link>
            <Link href={ `tel:${ Fijo }` }><span className='material-symbols-outlined'>call</span></Link>
          </Card>
        );
      }
    )
