...
export function NuevasNotificacionesSection() {
  ...
  return (
    <section className={form.section}>
      <h3 className={ `${ form.title } ${ typography.displayMedium }` }>Notificaciones</h3>
      <Accordion>
        ...
        <InputSection name={ 'Notificaciones.AutoNotificado' } title={ 'Auto notificado' } type={ 'date' } />
        <InputSection name={ 'Notificaciones.Certimail' } title={ 'Certimail' } type={ 'checkbox' } />
        <InputSection name={ 'Notificaciones.Fisico' } title={ 'Fisico' } type={ 'checkbox' } />
        <InputSection name={ 'Notificaciones.Tipo' } title={ 'Tipo' } type={ 'text' } />
      </Accordion>
    </section>
  );
}
