...
export function NuevoProceso(
  ...
  const {
    ...
    handleSubmit,
    formState: {
      errors, dirtyFields, submitCount, isSubmitting, isSubmitSuccessful, isLoading, isSubmitted
    },
    control
  } = methods;
      ...
      <FormProvider {...methods}>
        <div className={form.container}>
          ...
          >
            ...
            />
            <section className={ form.section }>
              <InputSection name={ 'deudor.primerNombre' } title={ 'Primer Nombre' } type={ 'text' } rls={{
                required: true
              }} />
              <InputSection name={ 'deudor.segundoNombre' } title={ 'Segundo Nombre' } type={ 'text' } />
              <InputSection name={ 'deudor.primerApellido' } title={ 'Primer Apellido' } type={ 'text' } rls={{
                required: true
              }}/>
              <InputSection name={ 'deudor.segundoApellido' } title={ 'segundo apellido' } type={ 'text' } />
              <InputSection name={ 'deudor.cedula' } title={ 'Cedula de Ciudadania' } type={ 'nuumber' } />
              <InputSection
                name={'deudor.email'}
          ...
          Tipo de proceso
            ...
            />
            <InputSection name={ 'grupo' } title={ 'Es de bancolombia o reintegra o lios juridicos' } type={ 'text' } rls={{
              required: true
            }} />
            <InputSection name={ 'fechaIngreso' } title={ 'fecha de ingreso del deudor al sistema de RyS' } type={ 'date' } rls={{
              required: true
            }} />
            <InputSection name={ 'reparto' } title={ '¿Ya se envió aa reparto?' } type={ 'checkbox' } rls={{
              required: true
            }}/>
            <section className={form.section}>
              <label
