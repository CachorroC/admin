...
export const NotasList = ({ notas }: { notas: monNota[] }) => {
  ...
  function scrollToId(notaId: string) {
    const map = getMap();
...
export const NotaFRef = forwardRef(function NotaFRef(
...
export function Form({ notas }: { notas: monNota[] }) {
  return (
    <form>
      {notas.map((nt, i) => {
        return (
