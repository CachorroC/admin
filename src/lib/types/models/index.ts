...
import { IntCarpeta, TipoProceso } from '../demandados';
...
const mess= [
  ...
  },
  {
    ...
    obligacion       : {
      '0': {
        codigo: '320088443  - 377813441863587'
      },
      '1': {
        codigo: 4513070212799642
      }
    },
  ...
  },
  {
    ...
    obligacion       : {
      '0': {
        codigo: '1740086734 4513073749673967'
      },
      '1': {
        codigo: 5303719549810730
      }
    },
  ...
  },
  {
    ...
    obligacion       : {
      '0': {
        codigo: '180049   53037120066499008'
      },
      '1': {
        codigo:
  ...
  },
  {
    ...
    obligacion       : {
      '0': {
        codigo: 'AMERICAN 0377814037749057'
      },
      '1': {
        codigo:
  ...
  },
  {
    ...
    obligacion       : {
      '0': {
        codigo: '20990123680  7-  377813468472239'
      },
      '1': {
        codigo:
...
const plainMaps = mess.map(
  (
    ...
    const meh: IntCarpeta = {
      numero           : messito.numero,
      deudor           : messito.deudor,
      capitalAdeudado  : messito.capitalAdeudado ?? 0,
      fechaIngreso     : new Date(),
      reparto          : true,
      codeudor         : messito.codeudor,
      tipoProceso      : messito.tipoProceso as TipoProceso,
      tipoBien         : messito.bien ,
      obligacion       : messito.obligacion,
      llaveProceso     : messito.llaveProceso,
      grupo            : 'Bancolombia',
      clase            : messito.bien ?? 'sin especificar',
      vencimientoPagare: undefined,
      idProceso        : []
    };
